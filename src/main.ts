...
function update(canvas : HTMLCanvasElement, ctx : CanvasRenderingContext2D, constants : ReturnType<typeof setup>['constants'], gameObjects : ReturnType<typeof setup>['gameObjects']) {
